        ...
        >
          ...
          <div className="border border-gray-200 rounded-lg p-8 bg-white">
            ...
            <button
              ...
              className="w-full rounded-none font-mono mb-4 px-4 py-3 border-2 border-gray-300 bg-white hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
            >
              <svg
                width="18"
                height="18"
