...
Return ONLY valid JSON:
{
  ...
  "updates": ["<string>"]
    ...
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${process.env.REACT_APP_GEMINI_API_KEY as string}`;
